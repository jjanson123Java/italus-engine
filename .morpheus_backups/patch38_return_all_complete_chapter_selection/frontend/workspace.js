  ...
  function renderChapterPlanner(bootstrap) {
    ...
    mainPanel.innerHTML = `
      <div class="workspace-content workspace-chapter-planner-v1">
        ...
        <details class="chapter-planner-card" open>
        ...
        <details class="chapter-planner-card chapter-plan-amendment-card">
        ...
        <details class="chapter-planner-card story-control-registry-card">
        ...
        <section class="chapter-planner-card chapter-knowledge-pack-card">
          ...
          <p class="placeholder">
            <strong>Chapter workflow:</strong> Plan the chapter → Save Chapter Plan → Compile Chapter Knowledge Pack.
