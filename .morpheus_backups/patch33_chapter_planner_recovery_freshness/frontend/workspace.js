(function () {
  ...
  function renderChapterPlanner(bootstrap) {
    ...
    const availableEventRows = events
      ...
      <div class="workspace-content workspace-chapter-planner-v1">
        ...
        <section class="chapter-planner-card">
          ...
          <div id="chapter-event-available-list" class="chapter-event-sequence-list">
            ${availableEventRows || '<div class="workspace-disabled-note">No additional Book Canon events are available.</div>'}
          </div>
        </section>
        ...
        <section class="chapter-planner-card chapter-knowledge-pack-card">
          ...
          <div class="workspace-stat-grid">
            ${statCard('Pack Status', labelFor(knowledgePackStatus))}
          ...
          ${knowledgePackBlockerRows
            ...
            : '<div class="workspace-success-note">All upstream planning dependencies are current. Save any unsaved chapter edits, then compile the Chapter Knowledge Pack.</div>'}
          <div class="workspace-action-row compact-action-row knowledge-pack-workflow-actions">
            ...
            <button type="button" id="chapter-compile-book-knowledge" class="primary-action compact-action" ${readOnly || loading || knowledgePackBusy || bookKnowledgeCompileBusy || !bookKnowledgeCompileAllowed || chapterDraftDirty ? 'disabled' : ''}>${bookKnowledgeCompileBusy ? 'Compiling Book Knowledge Pack…' : `Compile Book ${number(state.chapterPlanBookNumber)} Knowledge Pack`}</button>
          ...
          <div class="chapter-planner-actions">
            <button type="button" id="chapter-knowledge-pack-compile"
              ${readOnly || loading || knowledgePackBusy || chapterKnowledgePack.compiler_ready !== true || chapterDraftDirty ? 'disabled' : ''}>
