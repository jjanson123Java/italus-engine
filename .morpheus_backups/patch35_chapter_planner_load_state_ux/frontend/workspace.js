    ...
    mainPanel.innerHTML = `
      <div class="workspace-content workspace-chapter-planner-v1">
        ...
        <section class="chapter-planner-card chapter-knowledge-pack-card">
          ...
          <p class="placeholder">
            Use this workflow in order: <strong>1. Edit the Chapter Plan → 2. Save Chapter Plan → 3. Compile Chapter Knowledge Pack.</strong>
            The Book Knowledge Pack is a separate upstream artifact and should be recompiled only when its own status is not current.
            Recompiling the Chapter Knowledge Pack replaces the existing chapter pack files from the newly saved Chapter Plan.
          </p>
          ...
          ${chapterDraftDirty
            ? '<div class="workspace-warning-note chapter-pack-next-step"><strong>Next step: Save Chapter Plan.</strong> Your on-screen chapter changes are not yet the saved planning state. After saving, compile the Chapter Knowledge Pack to replace its old .md/.json contents. Do not recompile the Book Knowledge Pack unless its own status requires it.</div>'
            : bookKnowledgeOnlyBlocker
              ? `<div class="workspace-warning-note chapter-pack-next-step"><strong>Next step: Compile Book ${number(state.chapterPlanBookNumber)} Knowledge Pack.</strong> The chapter compiler is waiting on that upstream Book pack. After the Book pack is current, compile the Chapter Knowledge Pack.</div>`
              : knowledgePackBlockerRows
                ...
                : knowledgePackFile.current === true
                  ? '<div class="workspace-success-note chapter-pack-next-step"><strong>No pack action is required.</strong> The Chapter Knowledge Pack matches the saved Chapter Plan and current upstream planning dependencies.</div>'
                  : chapterKnowledgePack.compiler_ready === true
                    ? '<div class="workspace-warning-note chapter-pack-next-step"><strong>Next step: Compile Chapter Knowledge Pack.</strong> This will replace the existing chapter .md/.json files from the current saved Chapter Plan. Any Canon or events you returned and then saved will be removed from the rebuilt chapter pack.</div>'
                    : '<div class="workspace-disabled-note chapter-pack-next-step"><strong>Chapter Knowledge Pack is blocked.</strong> Resolve the listed upstream planning blocker before compiling.</div>'}
          <div class="workspace-action-row compact-action-row knowledge-pack-workflow-actions">
            ...
            <button type="button" id="chapter-compile-book-knowledge" class="primary-action compact-action" ${readOnly || loading || knowledgePackBusy || bookKnowledgeCompileBusy || !bookKnowledgeCompileAllowed ? 'disabled' : ''}>${bookKnowledgeCompileBusy ? 'Compiling Book Knowledge Pack…' : bookKnowledgeIsCurrent ? `Book ${number(state.chapterPlanBookNumber)} Knowledge Pack Current` : `Compile Book ${number(state.chapterPlanBookNumber)} Knowledge Pack`}</button>
